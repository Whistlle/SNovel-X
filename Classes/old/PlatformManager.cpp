...
L2DTextureDesc* PlatformManager::loadTexture(live2d::ALive2DModel* model, int no, const char* path)
{
	...
	const Texture2D::TexParams texParams = { GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE };
	...
	auto textureDesc=new LAppTextureDesc(texture);
